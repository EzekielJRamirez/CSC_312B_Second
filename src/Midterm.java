...
//            C11 = matrixAdd(strassensMMRecursive(A11, B11), strassensMMRecursive(A12, B21));
//            C12 = matrixAdd(strassensMMRecursive(A11, B12), strassensMMRecursive(A12, B22));
//            C21 = matrixAdd(strassensMMRecursive(A21, B11), strassensMMRecursive(A22, B21));
//            C22 = matrixAdd(strassensMMRecursive(A21, B12), strassensMMRecursive(A22, B22));
